"""
ddlcWiki data module. (Doki doki literature club Python wiki API)
Made for the ddlcWiki API.
...
CharacterInfo = {
    ...
    "yuriInfo": {
        "Name": "Yuri",
        "Age": 18,
        "PoemFont": "JP hand slanted (Act 1) and Demagrafic script MT (Act 2)",
        "Height": "5'5'' (165cm)",
